...
class FoodDetailForMealController: UICollectionViewController, UICollectionViewDelegateFlowLayout {
    ...
    override func viewDidLoad() {
        ...
        self.collectionView!.register(FoodDetailForMealSecondCell.self, forCellWithReuseIdentifier: secondCellId)
        self.collectionView!.register(FoodDetailForMealThirdCell.self, forCellWithReuseIdentifier: thirdCellId)
    ...
    override func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        if(indexPath.item == 1){
            ...
            let cell = collectionView.dequeueReusableCell(withReuseIdentifier: secondCellId, for: indexPath) as! FoodDetailForMealSecondCell
            cell.foodDetailForMealController = self
            
            return cell
        }
        if(indexPath.item == 2){
            
            let cell = collectionView.dequeueReusableCell(withReuseIdentifier: thirdCellId, for: indexPath) as! FoodDetailForMealThirdCell
            cell.foodDetailForMealController = self
