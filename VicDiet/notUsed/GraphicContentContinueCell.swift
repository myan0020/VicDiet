//
//  GraphicContentContintueCell.swift
//  VicDiet
//
...
class GraphicContentContinueCell: UICollectionViewCell{
    ...
    let nutrientTypeTextViewLeft: UITextView = {
        ...
        let attributedText = NSMutableAttributedString(string: "Water", attributes: [NSAttributedString.Key.font : UIFont.boldSystemFont(ofSize: 13)])
    ...
    let nutrientTypeTextViewMiddle: UITextView = {
        let textView = UITextView()
        let attributedText = NSMutableAttributedString(string: "Vitamin", attributes: [NSAttributedString.Key.font : UIFont.boldSystemFont(ofSize: 13)])
        textView.backgroundColor = UIColor.white
    ...
    let nutrientTypeTextViewRight: UITextView = {
        let textView = UITextView()
        let attributedText = NSMutableAttributedString(string: "Cellulose", attributes: [NSAttributedString.Key.font : UIFont.boldSystemFont(ofSize: 13)])
        textView.backgroundColor = UIColor.white
