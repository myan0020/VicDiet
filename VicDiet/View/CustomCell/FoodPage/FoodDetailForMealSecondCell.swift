...
class FoodDetailForMealSecondCell: UICollectionViewCell,UICollectionViewDataSource, UICollectionViewDelegate, UICollectionViewDelegateFlowLayout{
    
    var foodDetailForMealController: FoodDetailForMealController?
    ...
    func collectionView(_ collectionView: UICollectionView, numberOfItemsInSection section: Int) -> Int {
        return self.foodDetailForMealController?.detailList.count ?? 0
    }
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        cell.cellTextViewLabel.text = self.foodDetailForMealController?.detailTitle[indexPath.item]
        cell.cellTextViewValue.text = self.foodDetailForMealController?.detailList[indexPath.item]
        return cell
    }
