...
class FoodIntakeTodayGuideView: UIView {
    ...
    let label: UILabel = {
        ...
        label.text = "Your food items added today should be visible in this place after successfully adding foods or meals."
    ...
    override init(frame: CGRect) {
        ...
        //                    endAngle: 2.0 * .pi,
        //                    clockwise: false)
        path.addRects([CGRect(x: 0, y: 64 + frame.height*0.45, width: frame.width, height: frame.height*0.3),CGRect(x: 0, y: 0, width: frame.width, height: frame.height)])
