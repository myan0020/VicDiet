...
class MainMenuAddGuideView: UIView {
    ...
    let label: UILabel = {
        ...
        label.text = "This add function can provide you with plenty of ways to add foods you want eat into today's food intake list. By clicking on the button, you choose a preferred way to add your food."
...
//        skipOutButton.center = CGPoint(x: 25, y: 15)
        ...
        //                    endAngle: 2.0 * .pi,
        //                    clockwise: false)
        path.addRects([CGRect(x: frame.width/2 - 55/2, y: frame.height - 50, width: 55, height: 45),CGRect(x: 0, y: 0, width: frame.width, height: frame.height)])
        ...
        //        transparentHoleView.frame.size
        //            = CGSize(width: frame.width/4, height: 46)
        //        transparentHoleView.center = CGPoint(x: frame.width*5/6, y: frame.height - 55/2)
        //
        //        addSubview(skipOutButton)
        //        skipOutButton.frame.size = CGSize(width: 50, height: 40)
        //        skipOutButton.center = CGPoint(x: 25, y: 15)
