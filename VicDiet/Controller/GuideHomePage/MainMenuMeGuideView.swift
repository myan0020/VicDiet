...
class MainMenuMeGuideView: UIView {
    ...
    let label: UILabel = {
        ...
        label.text = "When you have updated your physical information, you can check it by clicking on here."
    ...
    override init(frame: CGRect) {
        ...
        //                    endAngle: 2.0 * .pi,
        //                    clockwise: false)
        path.addRects([CGRect(x: frame.width*5/6 - 25, y: frame.height - 50, width: 55, height: 45),CGRect(x: 0, y: 0, width: frame.width, height: frame.height)])
