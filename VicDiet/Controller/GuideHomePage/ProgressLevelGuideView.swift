...
class ProgressLevelGuideView: UIView {
    ...
    let label: UILabel = {
        ...
        label.text = "My dietary level measures the entire progress based on what you have eaten today.                By clicking on it, you will be provided your detailed information of today's dietary level including each nutrition progress. "
    ...
    override init(frame: CGRect) {
        ...
        label.topAnchor.constraint(equalTo: topAnchor, constant: 64 + frame.height*0.42 + 20).isActive = true
        ...
        //                    endAngle: 2.0 * .pi,
        //                    clockwise: false)
        path.addRects([CGRect(x: frame.width/30, y: 64 + frame.height*0.02, width: frame.width - frame.width/15, height: frame.height*0.4),CGRect(x: 0, y: 0, width: frame.width, height: frame.height)])
