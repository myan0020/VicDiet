...
class MainMenuHomeGuideView: UIView {
    ...
    let label: UILabel = {
        ...
        label.text = "In home page, you can see the overview of today's intake."
    ...
    override init(frame: CGRect) {
        ...
        //                    endAngle: 2.0 * .pi,
        //                    clockwise: false)
        path.addRects([CGRect(x: frame.width/12, y: frame.height - 50, width: 55, height: 45),CGRect(x: 0, y: 0, width: frame.width, height: frame.height)])
